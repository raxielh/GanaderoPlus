...
<div class="form-group col-sm-3">
    ...
    @if ($registroCompra === 0)
        {!! Form::date('fecha_ingreso', date('Y-m-d'), ['class' => 'form-control']) !!}
    @else
        {!! Form::date('fecha_ingreso', \Carbon\Carbon::parse($registroCompra->fecha_ingreso)->format('Y-m-d'), ['class' => 'form-control']) !!}
    @endif
</div>
<!-- Estado Id Field -->
<div class="form-group col-sm-3">
...
<div class="form-group col-sm-3">
    ...
    {!! Form::number('deduccion', null, ['class' => 'form-control','required' => 'true','placeholder' => 'Porcentaje de deduccion']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    <div class="col-md-1 col-xs-1 col-sm-1" style="margin-top: 7px;padding-left: 0px; padding-right: 0px;">
        <br>
        <a href="{!! route('lugarProcedencias.create') !!}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i></a>
    </div>
</div>
...
<div class="form-group col-sm-6">
    ...
    <div class="col-md-1 col-xs-1 col-sm-1" style="margin-top: 7px;padding-left: 0px; padding-right: 0px;">
        <br>
        <a href="{!! route('vendedores.create') !!}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i></a>
    </div>
</div>
...
<div class="form-group col-sm-6">
    ...
    <div class="col-md-1 col-xs-1 col-sm-1" style="margin-top: 7px;padding-left: 0px; padding-right: 0px;">
        <br>
        <a href="{!! route('compradores.create') !!}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i></a>
    </div>
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('responsable_id',$ResponsableCompras, null, ['class' => 'form-control chosen-select']) !!}
    </div>
    <div class="col-md-1 col-xs-1 col-sm-1" style="margin-top: 7px;padding-left: 0px; padding-right: 0px;">
        <br>
        <a href="{!! route('responsableCompras.create') !!}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i></a>
    </div>
</div>
